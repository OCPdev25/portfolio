...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="16 16 32 32" {...rest}>
	<path
		fill="url(#python-a)"
	...
	/>
	<defs>
		<linearGradient id="python-a" x1="19.075" x2="34.898" y1="18.782" y2="34.658" gradientUnits="userSpaceOnUse">
			<stop stop-color="#387EB8" />
			<stop offset="1" stop-color="#366994" />
		</linearGradient>
		<linearGradient id="python-b" x1="28.809" x2="45.803" y1="28.882" y2="45.163" gradientUnits="userSpaceOnUse">
