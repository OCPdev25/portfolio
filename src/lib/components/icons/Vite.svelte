...
<svg viewBox="0 0 256 257" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" {...rest}>
	<defs>
		<linearGradient x1="-.828%" y1="7.652%" x2="57.636%" y2="78.411%" id="vitejs-a">
			<stop stop-color="#41D1FF" offset="0%" />
			<stop stop-color="#BD34FE" offset="100%" />
		</linearGradient>
		<linearGradient x1="43.376%" y1="2.242%" x2="50.316%" y2="89.03%" id="vitejs-b">
