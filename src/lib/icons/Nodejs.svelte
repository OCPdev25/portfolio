...
<svg viewBox="0 0 256 292" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" {...rest}>
	<defs>
		...
		<linearGradient id="nodejs-c" x1="43.277%" x2="159.245%" y1="55.169%" y2="-18.306%">
		...
		<linearGradient id="nodejs-f" x1="-4.389%" x2="101.499%" y1="49.997%" y2="49.997%">
